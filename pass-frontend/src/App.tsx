...
import { PassGame } from './games/pass/PassGame';

const GAME_ID = 'pass';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Pass';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_PASS_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
